...
#-------------get id from url------------------------        
        ...
        $data_query = "select* from projects where ID = '$id' ";
        ...
        <div class="card-body">
          <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number text-center text-muted mb-0"><?php echo $row['Project_duration'];  ?></span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              <h3 class="text-primary"><i class="fas fa-paint-brush"></i> <?php  echo$row['Project_Name']; ?></h3>
              <p class="text-muted"><?php  echo$row['Description']; ?></p>
              <br>
              <div class="text-muted">
                <p class="text-sm">Client Company
                  <b class="d-block"><?php  echo $row['Client_Org']; ?></b>
                </p>
                <p class="text-sm">Project Leader
                  <b class="d-block"><?php  echo $row['Project_Lead']; ?></b>
                </p>
              </div>
